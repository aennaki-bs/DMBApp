...
export function UserActionsDropdown({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="bg-blue-950/95 backdrop-blur-xl border border-blue-800/30 text-blue-100 rounded-lg shadow-lg p-1.5 animate-in fade-in-0 zoom-in-95 duration-100"
      >
        <DropdownMenuLabel className="flex items-center gap-2 text-blue-200 px-3 py-2">
          <UserCog className="h-4 w-4 text-blue-400" />
          {t("userManagement.userActions")}
        </DropdownMenuLabel>
        <DropdownMenuSeparator className="bg-blue-700/40 my-1" />
