    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Total Discount */}
                <Card className="bg-gradient-to-br from-red-900/30 to-rose-900/30 border-red-500/20 p-6">
                ...
                {/* Total HT */}
                <Card className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border-green-500/20 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                ...
                {/* Total VAT */}
                <Card className="bg-gradient-to-br from-purple-900/30 to-violet-900/30 border-purple-500/20 p-6">
                    <div className="flex items-center justify-between">
                        <div>
