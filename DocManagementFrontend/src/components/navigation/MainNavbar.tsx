...
export function MainNavbar() {
  ...
  return (
    <div className=" border-b border-border shadow-sm sticky top-0 z-40">
      <div className="flex items-center justify-between h-16 px-responsive">
        {/* Left Section - Logo/Brand */}
        <Link
          to="/dashboard"
          className="flex items-center gap-responsive flex-shrink-0 hover:opacity-80 transition-opacity duration-200"
        >
          <EnhancedButton
            variant="ghost"
            size="icon"
            className="logo-responsive bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg shadow-lg"
          >
            <span
              className="font-black text-responsive-lg tracking-tight"
              style={{
          ...
          <span className="hidden sm:block text-responsive-xl font-bold text-foreground tracking-tight">
            DocuVerse
          </span>
        </Link>
