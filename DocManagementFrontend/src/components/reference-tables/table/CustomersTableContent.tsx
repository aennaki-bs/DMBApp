...
import { CustomersTableHeader } from "./content/CustomersTableHeader";
import { CustomersTableBody } from "./content/CustomersTableBody";
...
interface CustomersTableContentProps {
    ...
    selectedItems: string[]; // Array of customer codes from bulk selection
...
export function CustomersTableContent({
    customers,
    allCustomers,
    selectedItems,
    bulkSelection,
    ...
    const bulkActions: BulkAction[] = [
        {
            id: 'delete',
            label: 'Delete Customers (Disabled)',
            ...
            <div className="flex-1 relative overflow-hidden rounded-xl border border-primary/10 bg-gradient-to-br from-background/80 via-background/60 to-background/80 backdrop-blur-xl shadow-lg min-h-0">
                ...
                {hasCustomers ? (
                    ...
                    <div className="relative h-full flex items-center justify-center z-10">
                        <CustomerTableEmpty hasSearchQuery={!!searchQuery} onClearSearch={onClearFilters} />
                    </div>
                )}
            </div>
