...
import { VendorTableHeader } from "./content/VendorTableHeader";
import { VendorTableBody } from "./content/VendorTableBody";
...
interface VendorTableContentProps {
...
export function VendorTableContent({
  vendors,
  allVendors,
  selectedVendors,
  bulkSelection,
