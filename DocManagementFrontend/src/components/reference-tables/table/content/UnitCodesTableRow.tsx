...
import { MoreVertical, Edit, Eye, Trash2, Hash } from "lucide-react";
...
export function UnitCodesTableRow({
    unitCode,
    isSelected,
    onSelect,
    onEdit,
    ...
    return (
        ...
        >
            ...
            <TableCell className="w-[400px] text-blue-800 dark:text-blue-200">
                <span className="block truncate" title={unitCode.description}>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            ...
                            >
                                ...
                                <span className="sr-only">Open menu for {unitCode.code}</span>
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent
                            align="end"
