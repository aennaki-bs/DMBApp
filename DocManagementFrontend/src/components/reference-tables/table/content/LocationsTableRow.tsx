...
export function LocationsTableRow({
    location,
    isSelected,
    onSelect,
    onEdit,
    ...
    return (
        ...
        >
            ...
            <TableCell className="w-[400px] text-blue-800 dark:text-blue-200">
                <span className="block truncate" title={location.description}>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            ...
                            >
                                ...
                                <span className="sr-only">Open menu for {location.locationCode}</span>
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent
                            align="end"
