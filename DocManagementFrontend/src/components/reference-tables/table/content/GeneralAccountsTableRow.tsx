...
import { MoreVertical, Edit, Eye, Trash2, Calculator } from "lucide-react";
...
export function GeneralAccountsTableRow({
    account,
    isSelected,
    onSelect,
    onEdit,
    ...
    return (
        ...
        >
            ...
            <TableCell className="w-[400px] text-blue-800 dark:text-blue-200">
                <span className="block truncate" title={account.description}>
                    {account.description}
                </span>
            </TableCell>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            ...
                            >
                                ...
                                <span className="sr-only">Open menu for {account.code}</span>
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent
                            align="end"
