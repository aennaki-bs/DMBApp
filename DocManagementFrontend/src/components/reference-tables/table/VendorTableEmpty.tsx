...
interface VendorTableEmptyProps {
  onClearFilters: () => void;
}

export function VendorTableEmpty({ onClearFilters }: VendorTableEmptyProps) {
  return (
    <motion.div 
    ...
    >
      ...
      >
        No vendors match your current search and filter criteria. Try adjusting your filters or search terms.
      </motion.p>
