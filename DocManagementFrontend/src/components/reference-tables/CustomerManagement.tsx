    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-blue-100">Customer Management</h1>
            <p className="text-blue-300/80">Manage customer information and relationships</p>
          </div>
        </div>
                          ...
                          <AlertDialogDescription className="text-gray-300">
                            ...
                            {!canDeleteSelected && (
                              <div className="mt-2 p-2 bg-red-900/20 border border-red-500/30 rounded text-red-300">
                                Some selected customers have associated documents and cannot be deleted.
                              </div>
                            )}
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent className="bg-gray-900 border-gray-700">
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription className="text-gray-300">
                                    Are you sure you want to delete customer "{customer.name}" ({customer.code})?
                                    This action cannot be undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
