...
const EmailVerification = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] p-4">
      <Card className="w-full max-w-md border-gray-800 bg-gradient-to-b from-[#161b22] to-[#0d1117] shadow-2xl hover:shadow-blue-900/10 transition-all duration-300 backdrop-blur-sm relative overflow-hidden">
        <div className="absolute inset-0 bg-blue-600/5 rounded-lg pointer-events-none"></div>
        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-900/0 via-blue-900/20 to-blue-900/0 rounded-lg blur-sm opacity-20"></div>
        <CardHeader className="space-y-1 flex flex-col items-center pb-2 px-8 pt-6 border-b border-gray-800">
          ...
          <CardTitle className="text-2xl font-semibold text-white mt-4 text-center">
            Email Verification
          </CardTitle>
        ...
        <CardContent className="grid gap-6 pt-6">
          ...
          <div className="grid gap-2">
            <Label htmlFor="code" className="text-gray-300 text-center block">
              Verification Code
            </Label>
            <Input
              id="code"
