                    ...
                    <AnimatePresence>
                      {field.value === "simple" && (
                        <motion.div
                          ...
                          style={{ borderTopColor: colors.personal.border }}
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <span
                              ...
                              style={{ color: colors.personal.text }}
                            >
                              {t("userManagement.accessPersonalDocs")}
                            </span>
                          </div>
                          <div className="flex items-center gap-3">
                            <ShieldCheck
                            ...
                            <span
                              ...
                              style={{ color: colors.personal.text }}
                            >
                              {t("userManagement.basicWorkflow")}
                            </span>
                          </div>
                          <div className="flex items-center gap-3">
                            <ShieldCheck
                            ...
                            <span
                              ...
                              style={{ color: colors.personal.text }}
                            >
                              {t("userManagement.limitedPermissions")}
                            </span>
                          </div>
                        </motion.div>
                      )}
                    ...
                    <AnimatePresence>
                      {field.value === "company" && (
                        <motion.div
                          ...
                          transition={{ duration: 0.3 }}
                          className="border-t pt-4 space-y-3"
                          style={{ borderTopColor: colors.company.border }}
                        >
                          <div className="flex items-center gap-3">
                            <ShieldCheck
                              className="h-4 w-4"
                            ...
                            <span
                              ...
                              style={{ color: colors.company.text }}
                            >
                              {t("userManagement.advancedDocManagement")}
                            </span>
                          </div>
                          <div className="flex items-center gap-3">
                            <ShieldCheck
                            ...
                            <span
                              ...
                              style={{ color: colors.company.text }}
                            >
                              {t("userManagement.multiUserAccess")}
                            </span>
                          </div>
                          <div className="flex items-center gap-3">
                            <ShieldCheck
                            ...
                            <span
                              ...
                              style={{ color: colors.company.text }}
                            >
                              {t("userManagement.enhancedCollaboration")}
                            </span>
                          </div>
                        </motion.div>
                      )}
