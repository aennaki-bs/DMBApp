            ...
            >
                <DialogHeader>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <DialogTitle className="text-xl text-red-100">
                            Delete Selected {itemName === "element types" ? "Element Types" : itemName}
                        </DialogTitle>
                    </div>
                    <DialogDescription id="delete-description" className="text-red-300">
                        Are you sure you want to delete {count} {itemName}? This action cannot be undone.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="my-4 bg-red-900/20 backdrop-blur-sm p-4 rounded-lg border border-red-900/30">
                    <div className="flex items-center text-red-300 text-sm">
                        ...
                        <span>
                            Deleting {itemName} will remove all their information from the system.
                            Associated logs and audit trails will be preserved.
                        </span>
                    </div>
                </div>
                ...
                <DialogFooter>
                    ...
                    >
                        ...
                        Delete {count} {itemName === "element types" ? "Element Types" : itemName}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
